...
jQuery(document).ready(function(){
	...
	**/
	jQuery('#loginform').submit(function(){
		...
		if(username == '' && password == '') {
		    jQuery('#lognotify').slideDown('fast');	
			return false;
		} else {
			return true;
		}
	...
	**/
	 ...
	 * Widget Box Toggle
	**/
	jQuery('.widgetbox h3, .widgetbox2 h3, .widgetbox3 h3').hover(function(){
	...
	jQuery('.widgetbox h3, .widgetbox2 h3, .widgetbox3 h3').toggle(function(){
		jQuery(this).next().slideUp('fast');
