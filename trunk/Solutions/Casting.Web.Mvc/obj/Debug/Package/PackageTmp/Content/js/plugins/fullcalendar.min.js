...
(function (m, oa) {
                    ...
                    if (sa == "title") {
                        ...
                        if (ha) {
                            ...
                            var da = jb(b.buttonText, sa),
                                ma = m("<span class='fc-button fc-button-" + sa + " " + q + "-state-default'><span class='fc-button-inner'><span class='fc-button-content'>" + (ra ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + ra + "'/></span>" : da) + "</span><span class='fc-button-effect'><span></span></span></span></span>");
                            if (ma) {
                                ma.click(function () {
    ...
    function sb(a, b, e) {
        ...
        function g(w, I) {
            ...
            for (aa = 0; aa < w; aa++) {
                ...
                for (V = 0; V < F; V++) R += "<td class='fc- " + ea + " fc-day" + (aa * F + V) + "'><div>" + (I ? "<div class='fc-day-number'/>" : "") + "<div class='fc-day-content'><div style='position:relative'><span style='color:#FFF;'>Testekljwqvo ieru vgouiq rysdasvg oquyvgbqlih jqbvoiquybv oqrybvo qruyvb uvbasdeui vbryasdv beuiq&nbsp; </span></div></div></div></td>";
                R += "</tr>"
            }
            R += "</tbody></table>";
            w = m(R).appendTo(a);
    ...
    Aa.formatDate = Oa;
    Aa.formatDates = ib;
    var lc = ["dom", "seg", "ter", "qua", "qui", "sex", "sab"],
        Ab = 864E5,
        cc = 36E5,
        wc = 6E4,
        dc = {
