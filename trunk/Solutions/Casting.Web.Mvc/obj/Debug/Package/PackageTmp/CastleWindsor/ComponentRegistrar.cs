namespace Casting.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Casting.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("Casting.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Casting.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("Casting.Web.Mvc")
            ...
            container.Register(
                AllTypes.FromAssemblyNamed("Casting.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("Casting.Tasks")
